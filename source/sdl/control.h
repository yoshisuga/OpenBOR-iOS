...
#elif IOS
    #define    CONTROL_ESC                 (JOY_LIST_FIRST + 16)
    #define    CONTROL_DEFAULT1_UP         (JOY_LIST_FIRST +20)
    #define    CONTROL_DEFAULT1_RIGHT        (JOY_LIST_FIRST + 21)
    #define    CONTROL_DEFAULT1_DOWN        (JOY_LIST_FIRST + 22)
    #define    CONTROL_DEFAULT1_LEFT        (JOY_LIST_FIRST + 23)
    #define CONTROL_DEFAULT1_FIRE1        (JOY_LIST_FIRST + 1)
    #define CONTROL_DEFAULT1_FIRE2        (JOY_LIST_FIRST + 2)
    #define    CONTROL_DEFAULT1_FIRE3        (JOY_LIST_FIRST + 3)
    #define    CONTROL_DEFAULT1_FIRE4        (JOY_LIST_FIRST + 4)
    #define    CONTROL_DEFAULT1_FIRE5        (JOY_LIST_FIRST + 5)
    #define    CONTROL_DEFAULT1_FIRE6        (JOY_LIST_FIRST + 6)
    #define CONTROL_DEFAULT1_START        (JOY_LIST_FIRST + 10)
    #define CONTROL_DEFAULT1_SCREENSHOT (JOY_LIST_FIRST + 17)
    #define    CONTROL_DEFAULT1_ESC        (JOY_LIST_FIRST + 16)
#else
#ifdef SDL2
